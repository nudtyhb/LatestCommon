 ...
 */
public class TypeInstruction2 extends AbstractInstruction {
   ...
   // private final int newObjectIdentifierSeqIndex;
    ...
    public  TypeInstruction2(final ReadMethod readMethod, final int lineNumber, final int opcode, final String typeDesc, final int index, long newObjIdSeqIndex) {
