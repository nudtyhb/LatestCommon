 ...
 */
public class MultiANewArrayInstruction2 extends AbstractInstruction {
...
//    private final int newObjectIdentifierSeqIndex;
    public  final long[] newObjectIdentifiers;

    public MultiANewArrayInstruction2(final ReadMethod readMethod, final int lineNumber,
            final String desc, final int dims, long[] newobjectidentifiers) {
    ...
    public MultiANewArrayInstruction2(final ReadMethod readMethod, final String desc,
            final int dims, final int lineNumber, final int index,
            long[] newobjectidentifiers) {
    ...
    public <InstanceType> InstanceType getNextInstance(TraceIterator infoProv,
        ...
        return instanceFactory.createInstructionInstance(this,
            ...
            new MultiANewArrayInstrInstanceInfo(this.newObjectIdentifiers));
    }
