 ...
 */
public class TableSwitchInstruction2 extends AbstractInstruction {
    ...
    public TableSwitchInstruction2(final ReadMethod readMethod, final int min,
            final int lineNumber, final int defaultHandler, final int[] handlers, final int index) {
