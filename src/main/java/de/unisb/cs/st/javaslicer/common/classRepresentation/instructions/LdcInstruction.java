...
public class LdcInstruction extends AbstractInstruction {
    ...
    public LdcInstruction(final ReadMethod readMethod, final int lineNumber, final Object constant, final int index) {
    ...
    public static LdcInstruction readFrom(final DataInputStream in, final MethodReadInformation methodInfo,
        ...
        switch (type) {
        case 0:
            constant = Integer.valueOf(OptimizedDataInputStream.readInt0(in));  //int
            break;
        case 1:
            constant = Double.valueOf(in.readDouble());    //double
            break;
        case 2:
            constant = stringCache.readString(in);     //string
            break;
        case 3:
            constant = Long.valueOf(OptimizedDataInputStream.readLong0(in));  //long
            break;
        case 4:
            constant = Float.valueOf(in.readFloat());  //float
            break;
        case 5:
