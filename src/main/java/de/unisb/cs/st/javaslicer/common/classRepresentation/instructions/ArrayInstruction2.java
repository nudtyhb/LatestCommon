 ...
 */
public class ArrayInstruction2 extends AbstractInstruction {
    ...
    public final long arrayId;
    public final int arrayIndex;

    public ArrayInstruction2(ReadMethod readMethod, int opcode,
            int lineNumber,
            long arrayTraceSeqIndex, int indexTraceSeqIndex) {
        super(readMethod, opcode, lineNumber);
        this.arrayId = arrayTraceSeqIndex;
        this.arrayIndex = indexTraceSeqIndex;
    }

    public ArrayInstruction2(ReadMethod readMethod, int lineNumber, int opcode,
    		long arrayTraceSeqIndex, int indexTraceSeqIndex, int index) {
